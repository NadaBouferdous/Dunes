...
class MaskRCNN(object):
    ...
    def build(self, mode, config):
        ...
        # Désactiver FPN, utilisez directement les sorties du backbone
        # rpn_feature_maps = [
        #    KL.Conv2D(256, (1, 1), name="reduce_channels_c2")(C2),
        #    KL.Conv2D(256, (1, 1), name="reduce_channels_c3")(C3),
        #    KL.Conv2D(256, (1, 1), name="reduce_channels_c4")(C4),
        #    KL.Conv2D(256, (1, 1), name="reduce_channels_c5")(C5)
        #]
        # mrcnn_feature_maps = [
        #    KL.Conv2D(256, (1, 1), name="reduce_channels_map_c2")(C2),
        #    KL.Conv2D(256, (1, 1), name="reduce_channels_map_c3")(C3),
        #    KL.Conv2D(256, (1, 1), name="reduce_channels_map_c4")(C4),
        #    KL.Conv2D(256, (1, 1), name="reduce_channels_map_c5")(C5)
        #]
